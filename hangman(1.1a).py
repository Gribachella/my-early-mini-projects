...
def get_word(completed_words_list):
    ...
    утёс хребет плато побережье поляна степь дубрава""".upper().split()
    ...
    скоросшиватель мультифора степлер хлебница противень скалка тёрка овощечистка пароочиститель
    озонатор секач""".upper().split()
    ...
    равноденствие гало глория мираж""".upper().split()
    ...
    туманность созвездие венера пульсар квазар перигей апогей юпитер меркурий""".upper().split()
